...
const Frontend = () => {
  ...
  const resources = [
    ...
    { title: 'SASS Documentation', link: 'https://sass-lang.com/documentation' },
    { title: 'TypeScript Handbook', link: 'https://www.typescriptlang.org/docs/' },
    { title: 'Redux Official Docs', link: 'https://redux.js.org/' },
    { title: 'Jest Testing Framework', link: 'https://jestjs.io/docs/getting-started' },
    { title: 'GitHub Docs', link: 'https://docs.github.com/' },
    { title: 'NPM Guide', link: 'https://docs.npmjs.com/' }
  ];

  const youtubeResources = [
    { title: 'HTML & CSS Crash Course', link: 'https://www.youtube.com/watch?v=UB1O30fR-EE' },
    { title: 'JavaScript for Beginners', link: 'https://www.youtube.com/watch?v=W6NZfCO5SIk' },
    { title: 'React Tutorial', link: 'https://www.youtube.com/watch?v=Ke90Tje7VS0' },
    { title: 'Tailwind CSS Full Course', link: 'https://www.youtube.com/watch?v=dFgzHOX84xQ' },
    { title: 'TypeScript Crash Course', link: 'https://www.youtube.com/watch?v=BwuLxPH8IDs' },
    { title: 'Redux Explained', link: 'https://www.youtube.com/watch?v=CVpUuw9XSjY' },
    { title: 'Git & GitHub for Beginners', link: 'https://www.youtube.com/watch?v=RGOj5yH7evk' }
  ];
  ...
  return (
    <div className="bg-gradient-to-br from-blue-200 to-blue-50 min-h-screen flex flex-col items-center justify-center text-white p-6">
      ...
      <img src="/roadmap_images/Frontend.jpg" alt="Frontend Roadmap" className="w-full max-w-4xl object-contain mb-4" />
