...
const Backend = () => {
  ...
  const resources = [
    { title: 'JavaScript Docs', link: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
  ...
  const youtubeResources = [
    { title: 'Java Full Course', link: 'https://www.youtube.com/watch?v=grEKMHGYyns' },
    { title: 'JavaScript Full Course', link: 'https://www.youtube.com/watch?v=PkZNo7MFNFg' },
    { title: 'PHP Full Course', link: 'https://www.youtube.com/watch?v=OK_JCtrrv-c' },
    { title: 'Python Crash Course', link: 'https://www.youtube.com/watch?v=rfscVS0vtbw' },
    { title: 'Node.js Full Course', link: 'https://www.youtube.com/watch?v=Oe421EPjeBE' },
    { title: 'Django Tutorial', link: 'https://www.youtube.com/watch?v=rHux0gMZ3Eg' },
    { title: 'Spring Boot Crash Course', link: 'https://www.youtube.com/watch?v=9SGDpanrc8U' },
    { title: 'MySQL Database Tutorial', link: 'https://www.youtube.com/watch?v=HXV3zeQKqGY' },
    { title: 'Git & GitHub Crash Course', link: 'https://www.youtube.com/watch?v=RGOj5yH7evk' },
  ];
  ...
  return (
    <div className="bg-gradient-to-br from-blue-200 to-blue-50 min-h-screen flex flex-col items-center text-black p-6">
      <img 
        ...
        alt="Backend Roadmap" 
        className="w-full max-w-[650px] h-auto object-cover rounded-lg shadow-lg mt-12 mb-6" 
      />
