...
const FullStack = () => {
  ...
  const resources = [
    ...
    { title: 'AWS Cloud Basics', link: 'https://aws.amazon.com/getting-started/' },
    { title: 'Flutter Docs', link: 'https://docs.flutter.dev/' },
    { title: 'React Native Docs', link: 'https://reactnative.dev/docs/getting-started' },
  ];

  const youtubeResources = [
    { title: 'Full Stack Development Course', link: 'https://www.youtube.com/watch?v=nu_pCVPKzTk' },
    { title: 'MERN Stack Full Course', link: 'https://www.youtube.com/watch?v=7CqJlxBYj-M' },
    { title: 'Django & React Full Course', link: 'https://www.youtube.com/watch?v=PTZiD44OEkM' },
    { title: 'PostgreSQL Full Tutorial', link: 'https://www.youtube.com/watch?v=qw--VYLpxG4' },
    { title: 'MongoDB for Beginners', link: 'https://www.youtube.com/watch?v=ExcRbA7fy_A' },
    { title: 'AWS for Beginners', link: 'https://www.youtube.com/watch?v=ulprqHHWlng' },
    { title: 'Flutter Full Course', link: 'https://www.youtube.com/watch?v=VPvVD8t02U8' },
  ...
  return (
    <div className="bg-gradient-to-br from-blue-200 to-blue-50 min-h-screen flex flex-col items-center text-white p-6">
      ...
      <img src="/roadmap_images/FullStack.jpg" alt="Full Stack Roadmap" className="w-full max-w-4xl object-contain mb-6" />
